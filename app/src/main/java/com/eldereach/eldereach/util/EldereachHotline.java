...
public class EldereachHotline {
    ...
    public static ArrayList<EldereachHotline> getHotlines() {
        ...
        list.add(new EldereachHotline(
                ...
                R.drawable.org_food_from_the_heart,
                "62804483"
        ));
        ...
        list.add(new EldereachHotline(
                ...
                R.drawable.org_lions_befrienders,
                "18003758600"
        ));
        ...
        list.add(new EldereachHotline(
                ...
                R.drawable.org_habitat_for_humanity,
                "67447326"
        ));
        ...
        list.add(new EldereachHotline(
                ...
                R.drawable.org_the_salvation_army,
                "65550188"
        ));
